...
if(count($_POST)>0) {
    require_once("db.php");
    $sql = "INSERT INTO tracking (TrackId, Location) VALUES ('" . $_POST["trackId"] . "','" . $_POST["location"] . "')";
    mysqli_query($conn,$sql);
    $current_id = mysqli_insert_id($conn);

    if(!empty($current_id)) {
        $message = "New Tracking Added Successfully";
    }
}
?>
<html lang="en">
            ...
            <div align="middle" class="header-content-inner">
                ...
                <form name="frmUser" method="post" action="">
                    <div style="width:500px;">
                        ...
                        <div align="right" style="padding-bottom:5px;"><a href="home.php" class="link"><img alt='List' title='List' src='Admin/images/list.png' width='15px' height='15px'/> List User</a></div>
                        <table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="table table-bordered">
                            <tr class="tableheader">
                                <td align="middle" colspan="2">Add Tracking Details</td>
                            </tr>
                            <tr>
                                <td><label>TrackId</label></td>
                                <td><input type="text" name="trackId" class="txtField" autocomplete="off" placeholder="Enter the TrackId"></td>
                            </tr>
                            <tr>
                                <td><label>Location</label></td>
                                <td><input type="text" name="location" class="txtField" autocomplete="off" placeholder="Enter the Location"></td>
                            </tr>
                            <tr>

                                <td align = "middle" colspan="2"><button type="submit" class="btn btn-default">Submit</button></td>
                            </tr>
                        </table>
                    </div>
                </form>
